...
namespace CapongaMaronga55\Woocommerce\ModuleResolvers;
...
class SchemaTypeModuleResolver extends AbstractModuleResolver
{
    ...
    public final const SCHEMA_WOOCOMMERCE = GatoGraphQLExtension::NAMESPACE . '\schema-woocommerce';
    ...
    public function getDependentOnActiveWordPressPlugins(string $module): array
    {
        ...
        return match ($module) {
            self::SCHEMA_WOOCOMMERCE => $requiredPluginFile !== '' ? [
                /**
    ...
    {
        return match ($module) {
            self::SCHEMA_WOOCOMMERCE => \__('WooCommerce Schema', 'gatographql-woocommerce'),
            default => $module,
        };
    }
    ...
    {
        return match ($module) {
            self::SCHEMA_WOOCOMMERCE => \__('Add schema elements for the WooCommerce extension for Gato GraphQL.', 'gatographql-woocommerce'),
